...
export const AddMonthlySchedule: FC<{
  onSubmit: (args: {
    canister: string;
    dom: number;
    hour: number;
    ...
    <Formik
      ...
      validate={(values) => {
        ...
        if (
          values.dom < 0 ||
          values.dom > 31 ||
          values.dom !== Math.floor(values.dom)
        ) {
          ret.dom =
            "Day of month must be an integer between 1 and 31 (or 0 to pick the last day of every month) ";
        }
...
export default AddMonthlySchedule;
